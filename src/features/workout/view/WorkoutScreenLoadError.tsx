...
type WorkoutScreenLoadErrorProps = {
  error: Error;
};

export function WorkoutScreenLoadError({ error }: WorkoutScreenLoadErrorProps) {
  return (
    <Screen
    ...
    >
      ...
      <AppText className="mt-4 max-w-sm text-center">
        Your active workout could not be loaded. Close and reopen the app to try
        again.
      </AppText>
